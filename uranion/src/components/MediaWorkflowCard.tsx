...
export default function MediaWorkflowCard() {
      ...
      >
        <div>
          ...
          >
            ...
            >
               Automate massive photo libraries with intelligent tagging, quality
              sorting, and color correction. Built for agencies handling 200+
              images per event, our scalable architecture ensures compliance
              while streamlining e-commerce integration.
            </p>
          </div>  
