...
export default function NewArtistTeamModel({isOpen, setIsOpen}) {
          ...
          <DialogPanel as='aside' className="max-w-[400px] w-full mb-auto overflow-y-auto h-screen ml-auto border bg-white">
            <div className="w-full flex flex-col h-full px-6">
                <div className="w-full">
                    ...
                    <div className="border px-5 py-2 border-[#DBDBDB] flex items-center justify-between rounded-3xl w-full ">
                        <p className='text-lg text-black'>Zayn@gmail.com</p>
                        <ViewerOption/>
                    </div>
            ...
            <div className="flex items-center justify-center gap-4 mb-9 mt-auto pb-6">
              <button onClick={() => setIsOpen(false)} className=' outline-none bg-black rounded-lg text-white w-[269px] h-11 border-none ring-0'>Create Team </button>
            </div>
            </div>
          </DialogPanel>
        </div>
