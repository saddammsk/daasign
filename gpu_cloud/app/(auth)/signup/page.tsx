          ...
          <div className="bg-gray-1000 dark:bg-black-1200 min-h-screen py-10 font-geist flex flex-col items-center justify-center px-6">
               <div className="max-w-[420px] w-full mx-auto">
                    ...
                    <div className="bg-white dark:bg-black-1100 dark:border-white/[10%] border p-6 w-full border-gray-1100 rounded-[10px] shadow-3xl">
                         <div className="text-center mb-6">
                              <h2 className="text-2xl font-semibold dark:text-gray-1400 leading-8 mb-2 tracking-[-0.4px] text-black-1000">Create your account</h2>
                              <p className="text-sm font-normal dark:text-gray-1500 leading-5 text-gray-1200">Sign up to start your free GPU trial instantly.</p>
                         </div>
                         <form action="">
                              <div className="mb-6">
                                   <InputField
                              ...
                              <p className="text-sm text-center font-normal dark:text-gray-1400 leading-[100%] text-black-1000">Already have an account? <Link href="/" className="underline"> Sign up</Link></p>
                         </form>
                    </div>
