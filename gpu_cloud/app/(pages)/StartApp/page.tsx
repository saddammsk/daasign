...
function page() {
     ...
     useEffect(() => {
          const timers = [
               setTimeout(() => setStep(2), 2000),   // Step 2 after 5s
               setTimeout(() => setStep(3), 4000),  // Step 3 after 10s
               setTimeout(() => {
                    setStep(4); // all done
                    setLoadingDone(true); // hide loading, show block image
               }, 6000),
          ];
     ...
     return (
          <div className='p-2'>
               <div className="bg-white overflow-hidden dark:bg-black-1000 w-full  rounded-[14px] md:shadow-4xl">
                    ...
                    <div className="flex">
                         <div className={`p-1  transition-all ease-in-out duration-300 ${isSidebarOpen ? 'xl:w-[calc(100%_-_340px)] lg:w-[calc(100%_-_270px)] w-full' : 'w-full'}`}>
                              {!loadingDone && (
                                   <div className="bg-gray-1000 min-h-[calc(100vh_-_90px)] md:p-8 px-4 py-3 dark:border-white/[10%] dark:bg-black-1100 border border-gray-1100 rounded-[10px]">
                                        <div className="h-[84vh] flex flex-col justify-center items-center">
                                             <img src="images/Exclude.svg" className="inline-block mb-[72px]" alt="" />
                                             <p className="text-sm font-medium mb-10 text-center leading-[100%] text-black-1000 dark:text-gray-1400">
                                                  Almost there! We’re getting everything ready. It should take less than
                                                  2 minutes, and setup time is completely free
                                             </p>

                                             <div className="max-w-[815px] mx-auto">
                                                  <div className="md:flex mb-10 gap-8">
                                                       {/* Step 1 (always done instantly) */}
                                                       <div className="relative md:mb-0 mb-8 md:after:content-[] md:after:block after:hidden after:bg-gray-1100 after:h-[1px] after:absolute after:w-[98%] after:left-9 after:top-[14px]">
                                                            <img src="images/tick-icon-blue.svg" className="mb-7" alt="" />
                                                            <h6 className="text-sm font-medium leading-5 text-black-1000 mb-1.5 dark:text-gray-1400">
                                                                 Starting Application
                                                            </h6>
                                                            <p className="text-sm leading-5 font-normal text-gray-1200 dark:text-gray-1500">
                                                                 Launching the selected app in your browser
                                                            </p>
                                                       </div>
                                                       ...
                                                       <div className="relative  md:mb-0 mb-8 md:after:content-[]  md:after:block after:hidden after:bg-gray-1100 after:h-[1px] after:absolute after:w-[98%] after:left-9 after:top-[14px]">
                                                            {step === 1 ? (
                                                                 <img src="images/loader-2.svg" className="mb-7 animate-spin" alt="" />
                                                            ) : (
                                                                 <img src="images/tick-icon-blue.svg" className="mb-7" alt="" />
                                                            )}
                                                            <h6 className="text-sm font-medium leading-5 text-black-1000 mb-1.5 dark:text-gray-1400">
                                                            ...
                                                            <p className="text-sm leading-5 font-normal text-gray-1200 dark:text-gray-1500">
                                                                 Everything is ready — starting your session
                                                            </p>
                                                       </div>
                                                       ...
                                                       <div className=" md:mb-0 mb-8">
                                                            {step < 3 ? (
                                                                 <h4 className="mb-7 w-7 h-7 text-sm font-medium leading-5 text-black/[50%] dark:text-gray-1400 flex items-center justify-center">
                                                                      3
                                                                 </h4>
                                                            ) : step === 3 ? (
                                                                 <img src="images/loader-2.svg" className="mb-7 animate-spin" alt="" />
                                                            ...
                                                            <p className="text-sm leading-5 font-normal text-gray-1200 dark:text-gray-1500">
                                                                 Finalizing setup and going live
                                                            </p>
                                                       </div>
                                                  </div>
                                                  <div className="text-center"> <button type="button" className="text-sm dark:bg-white/[0.05] dark:border-white/[15%] dark:text-gray-1400 transtion ease-in-out duration-500 hover:bg-gray-1000 dark:hover:bg-white/[0.08] cursor-pointer font-medium leading-5 py-2 px-4 inline-block rounded-lg bg-white border border-gray-1100 shadow-3xl text-black-1000">Cancel</button> </div>
                                             </div>
                                        </div>
                                   </div>
                              )}
                              ...
                              {/* Block Image replaces loader */}
                              {loadingDone && (
                                   <div className="bg-gray-1000 min-h-[calc(100vh_-_90px)] md:p-8 px-4 py-3 dark:border-white/[10%] dark:bg-black-1100 border border-gray-1100 rounded-[10px] flex items-center justify-center">
                                        <img src="images/img-placeholder.png" className="dark:invert-[1]" alt="" />
                                   </div>
                              )}
                         </div>
