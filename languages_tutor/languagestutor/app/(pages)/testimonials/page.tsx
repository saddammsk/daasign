...
import { reviewsQuery } from '@/app/lib/queries'
        ...
        <section className='py-14 lg bg-black1 bg-cover bg-center bg-no-repeat' >
            <div className="w-full max-w-[1340px] px-5 mx-auto">
                ...
                <div className="w-full">
                    <h1 className='lg:text-56 md:text-40 text-32 font-semibold text-neutral1 mb-4'>Hear from our students</h1>
                    <p className='md:text-lg max-w-[600px] text-base text-neutral3'>Master new languages with the guidance of certified native tutors. Experience tailored one-on-one sessions designed to fit your schedule, wherever you are. Achieve fluency with affordable, high-quality online lessons.</p>
                </div>
                </div>
